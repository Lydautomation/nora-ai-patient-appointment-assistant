...
![NORA n8n Workflow Overview](screenshots/nora-workflow-overview.png)

### Patient Interaction

Patients interact with NORA through n8n Web Chat to manage their appointments conversationally.

![NORA Web Chat](screenshots/nora-web-chat.png)
